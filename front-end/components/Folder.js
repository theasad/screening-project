...
export default function Folder(props) {
    const useStyles = makeStyles(theme => ({
        folder: {
            ...
            display: 'flex',
            alignItems: 'center',
            color: props.folder.color?props.folder.color: theme.palette.primary.main,
            transition: 'all 0.3s ease-out',
            borderRadius: 4,
            '&:hover': {
                backgroundColor: props.folder.color?props.folder.color: theme.palette.primary.main,
                color: '#fff',
            }
        },
        driveFolderIcon: {
